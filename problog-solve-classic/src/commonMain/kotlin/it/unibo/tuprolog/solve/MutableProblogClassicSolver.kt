...
internal class MutableProblogClassicSolver(
    ...
    override fun appendStaticKb(theory: Theory) {
        updateContext {
            val newStaticKb = staticKb + ProblogTheory(theory)
            copy(
    ...
    override fun loadDynamicKb(theory: Theory) {
        updateContext {
            copy(
                dynamicKb = ProblogTheory(theory).toMutableTheory(),
