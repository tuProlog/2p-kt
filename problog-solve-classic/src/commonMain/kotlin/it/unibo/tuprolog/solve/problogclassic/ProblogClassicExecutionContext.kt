...
import it.unibo.tuprolog.solve.MutableProblogClassicSolver
import it.unibo.tuprolog.solve.MutableSolver
import it.unibo.tuprolog.solve.ProblogClassicSolver
...
data class ProblogClassicExecutionContext(
    ...
    val depth: Int = 0,
    val step: Long = 0,
    val probRules: KtList<ProblogRule> = listOf(),
    val bdd: BinaryDecisionDiagram<ProblogSolutionTerm> = BinaryDecisionDiagram.Terminal(true),
) : ExecutionContext {
    init {
    ...
    override fun createMutableSolver(
        ...
        inputChannels: InputStore,
        outputChannels: OutputStore
    ): MutableSolver = MutableProblogClassicSolver(
        libraries,
        flags,
        staticKb,
        dynamicKb,
