...
import it.unibo.tuprolog.solve.ProblogChoicePointContext
...
internal data class StateRuleSelection(override val context: ProblogClassicExecutionContext) : AbstractState(context) {
    ...
    private fun ProblogClassicExecutionContext.computeCutLimit(magicCut: Boolean = false): CutLimit {
    ...
    private fun ProblogChoicePointContext?.performCut(cutLimit: CutLimit): ProblogChoicePointContext? {
        return when {
            this === null -> {
                null
            }
