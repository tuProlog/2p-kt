...
fun ProblogChoicePointContext?.nextDepth(): Int = if (this == null) 0 else this.depth + 1

fun ProblogChoicePointContext?.appendPrimitives(
...
fun ProblogChoicePointContext?.appendRules(
