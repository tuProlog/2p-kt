...
/**
 * Benchmark class for [ClassicSolver] implementation
 *
 * @author Enrico
 */
internal class ClassicSolverBenchmark : SolverFactory {
    ...
    fun `8-QueensBenchmark`() {
        ...
        val numberOfExecutions = 10 // it will take approximately 15s
//        val numberOfExecutions = 50 // it will take approximately 1m
