...
internal class AtomIndex(
    ...
    private fun Clause.asInnerAtom(): Atom = this.nestedFirstArgument().castToAtom()

    private fun SituatedIndexedClause.asInnerAtom(): Atom = this.innerClause.nestedFirstArgument().castToAtom()

    private fun IndexedClause.asInnerAtom(): Atom = this.innerClause.nestedFirstArgument().castToAtom()
}
