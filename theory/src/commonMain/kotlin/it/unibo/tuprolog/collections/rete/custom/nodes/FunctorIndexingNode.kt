...
internal class FunctorIndexingNode(
    ...
    private fun Clause.isGlobal(): Boolean = this.isRule && this.castToRule().head.nestedFirstArgument(nestingLevel).isVar
    ...
    private fun IndexedClause.nestedArity(): Int = this.innerClause.head!!.arityOfNestedFirstArgument(nestingLevel)
