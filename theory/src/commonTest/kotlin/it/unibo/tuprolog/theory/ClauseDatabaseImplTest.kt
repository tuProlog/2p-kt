...
/**
 * Test class for [ClauseDatabaseReteImpl] and [ClauseDatabase]
 *
 * @author Enrico
 */
internal class ClauseDatabaseImplTest {
    ...
    @BeforeTest
    fun init() {
        emptyClauseDatabase = ClauseDatabaseReteImpl(emptyList())
        filledClauseDatabase = ClauseDatabaseReteImpl(ClauseDatabaseUtils.wellFormedClauses)
    }

    @Test
    fun clauseDatabaseComplainsIFProvidingNotWellFormedClausesUponConstruction() {
        assertFailsWith<IllegalArgumentException> { ClauseDatabaseReteImpl(ClauseDatabaseUtils.notWellFormedClauses) }
    }
    ...
    fun plusClauseDatabasePreservesOrder() {
        ...
        val toBeTested = ClauseDatabaseReteImpl(firstHalfClauses) + ClauseDatabaseReteImpl(secondHalfClauses)
    ...
    fun plusClause() {
        val (firstHalfClauses, secondHalfClauses) = ClauseDatabaseUtils.wellFormedClausesHelves
        var toBeTested: ClauseDatabase = ClauseDatabaseReteImpl(firstHalfClauses)
