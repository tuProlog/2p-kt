...
internal object ReteTreeAssertionUtils {
    ...
    val otherFacts =
        listOf(
            ...
            LogicList.from(Atom.of("a"), tail = Var.anonymous()),
            LogicList.from(Atom.of("a"), Atom.of("b"), tail = Var.anonymous()),
            LogicList.from(Atom.of("a"), Atom.of("b"), Atom.of("c"), tail = Var.anonymous()),
