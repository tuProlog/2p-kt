...
object Factories {
    ...
    fun clauseMultisetOf(clauses: Iterable<Clause>): ClauseMultiSet = ClauseMultiSet.of(Unificator.default, clauses)

    fun emptyClauseQueue(): ClauseQueue = ClauseQueue.empty(Unificator.default)

    fun clauseQueueOf(clauses: Iterable<Clause>): ClauseQueue = ClauseQueue.of(Unificator.default, clauses)

    fun emptyIndexedTheory(): Theory = Theory.emptyIndexed(Unificator.default)

    fun indexedTheoryOf(clauses: Iterable<Clause>): Theory = Theory.indexedOf(Unificator.default, clauses)

    fun indexedTheoryOf(clauses: Array<Clause>): Theory = Theory.indexedOf(Unificator.default, *clauses)

    fun indexedTheoryOf(clauses: Sequence<Clause>): Theory = Theory.indexedOf(Unificator.default, clauses)

    fun indexedTheoryOf(clauses: Array<Scope.() -> Clause>): Theory = Theory.indexedOf(Unificator.default, *clauses)
    ...
    fun listedTheoryOf(clauses: Iterable<Clause>): Theory = Theory.listedOf(Unificator.default, clauses)

    fun listedTheoryOf(clauses: Array<Clause>): Theory = Theory.listedOf(Unificator.default, *clauses)

    fun listedTheoryOf(clauses: Sequence<Clause>): Theory = Theory.listedOf(Unificator.default, clauses)

    fun listedTheoryOf(clauses: Array<Scope.() -> Clause>): Theory = Theory.listedOf(Unificator.default, *clauses)
