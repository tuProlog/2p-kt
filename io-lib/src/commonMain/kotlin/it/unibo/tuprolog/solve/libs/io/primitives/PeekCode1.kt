...
object PeekCode1 : UnaryPredicate.NonBacktrackable<ExecutionContext>("peek_code") {
    override fun Solve.Request<ExecutionContext>.computeOne(first: Term): Solve.Response {
        ...
        return peekCodeAndReply(context.inputChannels.let { it.current ?: it.stdIn }, first)
    }

    internal fun Solve.Request<ExecutionContext>.peekCodeAndReply(channel: InputChannel<String>, arg: Term): Solve.Response {
        return try {
