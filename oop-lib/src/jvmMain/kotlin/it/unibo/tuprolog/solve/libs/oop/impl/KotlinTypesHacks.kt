...
internal object KotlinTypesHacks {
    ...
    private val typeCallableMap = TreeMap<CallableId, KCallable<*>>().also {
    ...
    operator fun get(type: KClass<*>, name: String, args: List<Any?>): KCallable<*>? =
        if (args.isNotEmpty()) null else typeCallableMap[CallableId(type, name)]
}
