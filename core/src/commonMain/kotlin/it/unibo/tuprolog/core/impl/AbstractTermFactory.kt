...
internal abstract class AbstractTermFactory : TermFactory {
    @JsName("_emptyLogicBlock")
    ...
    override fun logicListFrom(
        ...
        when (items) {
            ...
            else -> logicListFromCursor(items.cursor(), tail)
        }
