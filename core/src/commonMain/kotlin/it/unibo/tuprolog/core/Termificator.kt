...
interface Termificator {
    ...
    companion object {
        @JvmStatic
        @JsName("default")
        fun default(scope: Scope = Scope.empty()): Termificator = DefaultTermificator(scope, true)

        @JvmStatic
        @JsName("legacy")
        fun legacy(scope: Scope = Scope.empty()): Termificator = DefaultTermificator(scope, false)
