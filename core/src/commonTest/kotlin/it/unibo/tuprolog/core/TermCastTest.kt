...
class TermCastTest {
    ...
    private val asTypeTester = object : TermVisitor<Unit> {
    ...
    private val castToTypeTester = object : TermVisitor<Unit> {
        override fun defaultValue(term: Term) = Unit
    ...
    private val positiveTypeTester = object : TermVisitor<Unit> {
