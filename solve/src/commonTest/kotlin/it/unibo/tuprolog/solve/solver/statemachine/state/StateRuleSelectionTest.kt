...
internal class StateRuleSelectionTest {
    ...
    fun multipleNestedMatchingRulesTest() {
        ...
        val actualSubstitutions = interestingEndStates.map { with((it as FinalState).solve) { SolverUtils.reduceAndFilterSubstitution(context!!.substitution, solution.query.variables) }.values.single() }
