...
object Instances {
    val theoryWithCompoundTerms: Theory =
        logicProgramming {
            theoryOf(
    ...
    val theoryWithFreeVariablesInTheHead: Theory =
        logicProgramming {
            theoryOf(
    ...
    val theoryWithFreeVariablesInNegatedBodyLiterals: Theory =
        logicProgramming {
            theoryOf(
    ...
    val theoryWithRecursion: Theory =
        logicProgramming {
            theoryOf(
